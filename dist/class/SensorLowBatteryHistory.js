...
class SensorLowBatteryHistory extends Map {
    ...
    increment_history(sensor) {
        ...
        if (current != undefined) {
            ...
            console.error("Trying to increment an undefined lowbattery history for sensor " + sensor.name);
            this.reset_sensor_history(sensor);
        }
    }
}
exports.SensorLowBatteryHistory = SensorLowBatteryHistory;
